...
Other authors appear to have made a similar omission while modeling ISM conditions where the distinction between $T_{\rm rad}$ and $T_{\rm d}$ can be quite important \citep{dopcke_2011, grackle, kannan_2020_rt, rigel,zimmermann_2025}. Notably, this nuance was previously pointed out in a footnote in \citet{Cunningham_2018_feedback}, although they did not track the distinct temperatures in their simulation.
