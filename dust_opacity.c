...
double Tdust_zones[N_TDUST] = {160, 275, 425, 680,
                               1500}; // demarcation of T_dust zones
double logTrad_table[N_TRAD] = {0.0,
                                0.2857142857142857,
                                0.5714285714285714,
                                0.8571428571428571,
                                1.1428571428571428,
                                ...
                                3.714285714285714,
                                4.0};
double log_kappadust_table[N_TDUST][N_TRAD] = {
 ...
 */
double dust_planck_mean_opacity(double Trad, double Tdust) {
    double logTmax = logTrad_table[N_TRAD - 1], logTmin = logTrad_table[0];
    double logT = log10(Trad);
    ...
    double dlogT = logTrad_table[1] - logTrad_table[0];
    int Trad_idx = (int)(N_TRAD - 1) * logT / (logTmax - logTmin);
    double wt1 = 1 - (logT - logTrad_table[Trad_idx]) / dlogT, wt2 = 1 - wt1;
    double log_kappa = wt1 * log_kappadust_table[Tdust_idx][Trad_idx] +
